const en = {
    ...
    manager: {
        ...
        rehearsals: {
            title: 'Rehearsals',
            subtitle: 'Manage student rehearsal slots — one per student.',
            searchByStudent: 'Search by student email…',
            searchByArtist: 'Search by artist email…',
            create: 'Add rehearsal',
            import: 'Import rehearsals',
            createTitle: 'Add rehearsal',
            editTitle: 'Edit rehearsal',
            empty: 'No rehearsals found.',
            deleteConfirm: 'Delete this rehearsal?',
            artistEmail: 'Artist email',
            artistFullName: 'Artist name',
            artistFallbackHint: 'Used only if the email above doesn\'t match a registered user.',
        ...
        bookingLimits: {
            ...
            flags: {
                ...
                youthDone_A: 'Youth A Done',
                youthDone_B: 'Youth B Done',
                youthDone_C: 'Youth C Done',
                youthDone_D: 'Youth D Done',
            },
            rulesTitle: 'Rules',
        ...
        diplomas: {
            title: 'Diplomas',
            subtitle: 'Generate personalized diplomas from a template.',
            template: 'Diploma template',
            templatePlaceholder: 'Choose a template…',
            byTypeTitle: 'By category',
            byTypeDesc: 'Generate diplomas for every student with a given tag at once.',
            bookingType: 'Category',
            bookingTypePlaceholder: 'Choose a category…',
            generateByType: 'Generate all',
            noMatchingStudents: 'No students found with that category.',
            singleTitle: 'Single student',
            singleDesc: 'Search for one student by name or email.',
            generateSingle: 'Generate diploma',
            multiTitle: 'Multiple students',
            multiDesc: 'Pick specific students one at a time.',
            generateMulti: 'Generate all',
            masterclassTitle: 'Masterclass',
            masterclassDesc: 'Search by teacher name to find masterclass sessions, then select one or more to generate diplomas.',
            searchByTeacher: 'Teacher name',
            teacherPlaceholder: 'Search by teacher name…',
            noStudentLinked: 'No student linked',
            noActivitiesFound: 'No masterclass sessions found for that teacher.',
        },
        contestSettings: {
            title: 'Contest Settings',
            subtitle: 'Configure rounds, timing defaults, and performance days.',
            solo: 'Solo',
            youth: 'Youth',
            ...
            pieces: 'Pieces',
            addPiece: 'Add piece',
            warmUp: 'Warm-up offset',
            ready: 'Ready offset',
            stage: 'Stage duration',
            pauseEvery: 'Pause every N performances',
            pauseDuration: 'Pause duration',
            daysTitle: 'Days',
            addDay: 'Add day',
            editDay: 'Edit day',
            noDays: 'No days configured yet.',
            day: 'Day',
            date: 'Date',
            startTime: 'Start time',
            deleteRoundConfirm: 'Delete this round? This cannot be undone.',
            deleteDayConfirm: 'Delete this day?',
            validation: {
                nameVenueRequired: 'Round name and venue are required.',
                pieceRequired: 'At least one piece is required.',
                dayRequired: 'Date and start time are required.',
            },
            addCategoryConfig: 'Add category configuration',
            editCategoryConfig: 'Edit category configuration',
            noCategoryConfigs: 'No configuration added yet.',
            configuration: 'Configuration',
            deleteConfigConfirm: 'Delete this category\'s configuration? This cannot be undone.',
            endTime: 'End time',
            morningAccompanist: 'Morning accompanist',
            afternoonAccompanist: 'Afternoon accompanist',
            noAccompanist: 'None',
            accompanistHint: 'Performances before the lunch pause use the morning pianist; from lunch onward, the afternoon one.',
        },
        performanceOrder: {
            ...
            autoFill: 'Auto-fill days',
            addMissingStudent: 'Add missing student',
            noMissingStudentsFound: 'No matching students found.',
            recalculate: 'Recalculate times',
            title: 'Performance Order',
            subtitle: 'Generate and arrange the contest performance schedule.',
            selectRound: 'Select a round…',
            selectCategory: 'Select a category…',
            selectScopeFirst: 'Select a round (and category) to view its performance order.',
            validated: 'Validated',
            pendingValidation: 'Pending validation',
            generate: 'Generate order',
            generateConfirm: 'Generate a new random order? This replaces the current pending order.',
            validate: 'Validate',
